...
public class FragmentDialogQuestion extends DialogFragment {
    ...
    private static FragmentDialogQuestion newInstance(@Nullable @StringRes Integer titleId,
        ...
        if (positiveButtonTextId != null) {
            args.putInt(POSITIVE_BUTTON_TEXT, positiveButtonTextId);
        }
        if (negativeButtonTextId != null) {
            args.putInt(NEGATIVE_BUTTON_TEXT, negativeButtonTextId);
        }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (textId == 0) {
            textId = R.string.dialog_btn_cancel;
        }
